...
public class NotificationService {
	...
	public void deleteNotificationById(Long id) {
	 ...
	 public void createNotificationsForAppointment(Long appointmentID) {
	        ...
	        patientNotification.setMessage("Dear Patient, your appointment with Doctor ID " + appointment.getDoctor().getDoctorId() + " is scheduled on the date " +appointment.getDoctor().getDate()+" and the time "+ appointment.getAppointmentTime() + " and your appointment ID: " + appointmentID + ".");
	 ...
	 public void generateRemindersForAppointments() {
		    ...
		    // Filter appointments that are scheduled for tomorrow
		    ...
		    // Create and save reminders for each appointment
